...
Also read `decisions.md` from the project directory to incorporate any decisions made in earlier stages.
...
3. If the user confirms, add it to `{project-directory}/decisions.md`

Never write to decisions.md without explicit user confirmation.

## Output

Save the approved architecture to: `{project-directory}/architecture.md`
