...
Read all 6 findings files. Produce the final report following this format:
...
*Generated by repo-health-analyzer v1 (sequential mode). Auditors: {N} run, {N} skipped.*
```
